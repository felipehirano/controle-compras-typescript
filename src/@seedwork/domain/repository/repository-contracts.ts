...
/**
 * Essa classe será extremamente permissiva, por isso será necessário fazer alguns
...
export class SearchParams<Filter> {
    ...
    private set page(value: number) {
         ...
         * se nao for um inteiro em formato de string entao retorna um NaN;
         */
        let _page = +value;

        /**
         * Verificacao de float
         * parseInt(_page as any) !== _page
         * se for um float, na conversão ele retira o decimal tornando essa validacao falsa,
         * retornando 1 para caso seja passado um float
        */
...
> extends RepositoryInterface<E> {
    // É um array de campos que poderão ser aplicados os filtros;
